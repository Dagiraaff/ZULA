...
er redet ihre Vorschläge schlecht \cite[S. 266]{pir}  schimpft über die ´verflixten Weiber´ \cite[302]{pir}und hegt ihr gegenüber eine negative Grundeinstellung. \cite[S. 297]{pir}
Als er Käptn Morgan daran erinnert, dass Mohnschnecke, wie es eigentlich üblich ist (S.50)) 
auf dem Markt verkauft werden soll (S.129), stößt dabei aber auf wenig Interesse.
...
da er ´(a)ls ältestes Besatzungsmitglied (...) die meiste Erfahrung (...) (hatte)´\cite[S.371]}
 
Da er ´(e)ine Menge Mannschaftsmitglieder  (...) im Lauf der Zeit gegen sich aufgebracht (hatte),´ (S.151), 
